...
helm.sh/chart: {{ include "nodejs-service.chart" . }}
...
*/}}
{{- define "nodejs-service.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "nodejs-service.fullname" .) .Values.serviceAccount.name }}
{{- else }}
